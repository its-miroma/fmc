...
function generateTranslatedThemeConfig(localeCode: string): Fabric.ThemeConfig {
  ...
  return {
    ...
    editLink: {
      pattern: "http://gitlab.loc/root/fabric-docs/-/edit/main/:path",
      text: websiteResolver("gitlab_edit"),
    },
    ...
    footer: {
      copyright: websiteResolver("footer.copyright").replace(
        "%s",
        `<a href=\"http://gitlab.loc/root/fabric-docs/-/blob/main/LICENSE\" target=\"_blank\" rel=\"noreferrer\">${websiteResolver(
          "footer.license"
        )}</a>`
      ),
    ...
    notFound: {
      ...
      weblateLinkLabel: websiteResolver("404.weblate_link.label"),
      weblateLinkText: websiteResolver("404.weblate_link"),
    },
    ...
    socialLinks: [
      {
        icon: "gitlab",
        link: "http://gitlab.loc/root/fabric-docs",
        ariaLabel: websiteResolver("social.gitlab"),
      },
      {
        icon: "discord",
      ...
      {
        icon: "weblate",
        link: `http://weblate.loc/projects/fabricmc/${""}`,
        ariaLabel: websiteResolver("social.weblate"),
      },
    ],
