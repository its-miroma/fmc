...
export namespace Fabric {
  ...
  export interface NotFoundOptions {
    ...
    /**
     * Set aria label for Weblate link.
     *
     * @default "Open the Weblate editor"
     */
    weblateLinkLabel: string;

    /**
     * Set custom Weblate link text.
     *
     * @default "Localize on Weblate"
     */
    weblateLinkText: string;
