...
@[code transcludeWith=::1](@/reference/1.21.11/src/main/java/com/example/docs/component/ModComponents.java)
...
@[code transcludeWith=::2](@/reference/1.21.11/src/main/java/com/example/docs/component/ModComponents.java)
...
@[code transcludeWith=::1](@/reference/1.21.11/src/main/java/com/example/docs/item/custom/CounterItem.java)
...
@[code transcludeWith=::1](@/reference/1.21.11/src/main/java/com/example/docs/component/ComponentWithTooltip.java)
...
@[code lang=java transcludeWith=#tooltip_provider](@/reference/1.21.11/src/main/java/com/example/docs/ExampleMod.java)
...
@[code lang=java transcludeWith=#tooltip_provider_client](@/reference/1.21.11/src/client/java/com/example/docs/ExampleModClient.java)
...
@[code transcludeWith=:::_13](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)
...
@[code transcludeWith=::3](@/reference/1.21.11/src/main/java/com/example/docs/item/custom/CounterItem.java)
...
@[code transcludeWith=::2](@/reference/1.21.11/src/main/java/com/example/docs/item/custom/CounterItem.java)
...
@[code transcludeWith=::1](@/reference/1.21.11/src/main/java/com/example/docs/component/MyCustomComponent.java)
...
@[code transcludeWith=::2](@/reference/1.21.11/src/main/java/com/example/docs/component/MyCustomComponent.java)
...
@[code transcludeWith=::3](@/reference/1.21.11/src/main/java/com/example/docs/component/ModComponents.java)
