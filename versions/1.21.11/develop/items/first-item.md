...
@[code transcludeWith=:::1](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)
...
@[code transcludeWith=:::2](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)
...
@[code transcludeWith=:::3](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)

@[code transcludeWith=:::1](@/reference/1.21.11/src/main/java/com/example/docs/item/ExampleModItems.java)
...
@[code transcludeWith=:::4](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)
...
@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/models/item/suspicious_substance.json)
...
@[code](@/reference/1.21.11/src/main/generated/assets/example-mod/items/suspicious_substance.json)
...
@[code transcludeWith=:::_10](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)

Alternatively, if you want to make your item a fuel, you can use the `FuelRegistryEvents.BUILD` event:

@[code transcludeWith=:::_11](@/reference/1.21.11/src/main/java/com/example/docs/item/ModItems.java)
...
@[code lang=java transcludeWith=:::3](@/reference/1.21.11/src/main/java/com/example/docs/item/custom/LightningStick.java)
