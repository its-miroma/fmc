...
<<< @/reference/latest/src/main/java/com/example/docs/effect/TaterEffect.java#1
...
<<< @/reference/latest/src/main/java/com/example/docs/effect/ExampleModEffects.java#1
...
<<< @/reference/latest/src/main/java/com/example/docs/ReferenceMethods.java#1
