...
<<< @/reference/latest/src/client/java/com/example/docs/ExampleModDynamicSound.java#1
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/instance/CustomSoundInstance.java#1
...
<<< @/reference/latest/src/client/java/com/example/docs/ExampleModDynamicSound.java#2
...
<<< @/reference/latest/src/main/java/com/example/docs/sound/DynamicSoundSource.java#1
...
<<< @/reference/latest/src/main/java/com/example/docs/sound/TransitionState.java#1
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/instance/SoundInstanceCallback.java#1
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#1

Then set up the default starting values for the custom `SoundInstance` in the constructor of the abstract class.

<<< @/reference/latest/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#2

After the constructor is finished, you need to allow the `SoundInstance` to be able to play.

<<< @/reference/latest/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#3
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#4
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#5
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/AbstractDynamicSoundInstance.java#6
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/instance/EngineSoundInstance.java#1
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/DynamicSoundManager.java#1
...
<<< @/reference/latest/src/client/java/com/example/docs/sound/DynamicSoundManager.java#2
...
<<< @/reference/latest/src/client/java/com/example/docs/network/ReceiveS2C.java#1
