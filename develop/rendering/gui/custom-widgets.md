...
<<< @/reference/latest/src/client/java/com/example/docs/rendering/screens/CustomWidget.java#1
...
<<< @/reference/latest/src/client/java/com/example/docs/rendering/screens/CustomScreen.java#3
...
<<< @/reference/latest/src/client/java/com/example/docs/rendering/screens/CustomWidget.java#2
