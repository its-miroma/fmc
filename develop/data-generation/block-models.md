...
You can view the example tests in [Fabric API](https://github.com/FabricMC/fabric/blob/1.21.4/fabric-data-generation-api-v1/src/) and this documentation's [Reference Mod](http://gitlab.loc/root/fabric-docs/-/tree/main/reference) for more information.
