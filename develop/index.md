...
Remember: a fully-working mod with all the code for this documentation is available in the [`/reference` folder on GitLab](http://gitlab.loc/root/fabric-docs/-/tree/main/reference/latest).

If you want to contribute to the Fabric Documentation, you can find the source code on [GitLab](http://gitlab.loc/root/fabric-docs), and the relevant [contribution guidelines](../contributing).
