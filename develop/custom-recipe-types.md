...
<<< @/reference/latest/src/main/java/com/example/docs/recipe/UpgradingRecipeSerializer.java#map-codec

The stream codec can be created in a similar way using `StreamCodec#composite`:

<<< @/reference/latest/src/main/java/com/example/docs/recipe/UpgradingRecipeSerializer.java#stream-codec

Let's use these codecs to implement the methods from `RecipeSerializer`:

<<< @/reference/latest/src/main/java/com/example/docs/recipe/UpgradingRecipeSerializer.java#implementing
